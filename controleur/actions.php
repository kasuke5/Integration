<?php
	...
	if($event["site"] ==1){
		$commande_web = "./script_web.sh 2 ".$event["event_title"]." 2 ".$_SESSION["pass_user"]." ".$_SESSION["login_user"];
		$commande_bdd = "./script_bdd.sh 2 ".$event["event_title"]." ".$_SESSION["login_user"]." ".$_SESSION["pass_user"];
		exec($commande_bdd);
	}elseif ($event["site"] ==2) {
		$commande_web = "./script_web.sh 2 ".$event["event_title"]." 1 ".$_SESSION["pass_user"]." ".$_SESSION["login_user"];
	}elseif ($event["site"] ==3) {
		$commande_web = "./script_web.sh 2 ".$event["event_title"]." 1 ".$_SESSION["pass_user"]." ".$_SESSION["login_user"];
